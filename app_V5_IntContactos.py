...
def upload_file():
    ...
    if file:
        ...
        # Conectar a la base de datos y ejecutar la lógica de scoring y media de intentos
        ...
        ws = wb.active
        scoring_column_index = ws.max_column - 1  # Columna 'scoring'
        media_intentos_column_index = ws.max_column  # Última columna es 'media_intentos_para_contacto'
